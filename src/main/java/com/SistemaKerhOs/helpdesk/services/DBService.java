...
public class DBService {
	...
	@Autowired private ChamadoRepository chamadosRepository;
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Herberton Lauro", "550.482.150-95", "herberton.dev@mail.com", encoder.encode("123"));
		...
		Cliente cli1 = new Cliente(null, "Nicolas Ryan Teixeira", "114.226.471-88", "nicolas-teixeira72@bol.br", encoder.encode("123"));
		...
		chamadosRepository.saveAll(Arrays.asList(c1, c2, c3, c4, c5, c6));
